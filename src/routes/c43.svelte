<div class='wrapper'>
  <div class='ground'>
    ...
    <div class="palmtree tree-77"></div>
    <div class="palmtree tree-78"></div>
    <div class="tree tree-79"></div>
    <div class="tree tree-80"></div>
    <div class="tree tree-81"></div>
    <div class="palmtree tree-82"></div>
    <div class="tree tree-83"></div>
    <div class="palmtree tree-84"></div>
    <div class="tree tree-85"></div>
    <div class="palmtree tree-86"></div>
    <div class="palmtree tree-87"></div>
...
.art-1 {
  transform: translate(335px,225px) rotateX(-90deg) rotateY(calc(var(--rotate-y)*-1));
}
.art-2 {
  transform: translate(340px,230px) rotateX(-90deg) rotateY(calc(var(--rotate-y)*-1));
}
.art-1, .art-2 {
  font-size: 24px;
}
...
.computer {
  font-size: 24px;
  transform: translate(270px,190px) rotateX(-90deg) rotateY(calc(var(--rotate-y)*-1));
}
.computer-2 {
  font-size: 24px;
  transform: translate(300px,190px) rotateX(-90deg) rotateY(calc(var(--rotate-y)*-1));
}

.c43-0 {
    font-size: 70px;
    width: 94px;
    transform: translate(160px, 120px) rotateX(-90deg);
}
.c43 {
    font-size: 70px;
    width: 94px;
    transform: translate(230px, 120px) rotateX(-90deg);
}
.c43-1 {
    font-size: 70px;
    width: 94px;
    transform: translate(300px, 120px) rotateX(-90deg);
}
.c43-2 {
  font-size: 70px;
  width: 94px;
  transform: translate(335px, 155px) rotateX(-90deg) rotateY(90deg);
}
...
@keyframes bus2 {
    ...
    50% {
        transform: translate(650px, 490px) rotateX(-90deg) rotateY(180deg);
    }

    90% {
        transform: translate(20px, 490px) rotateX(-90deg) rotateY(180deg);
    }
